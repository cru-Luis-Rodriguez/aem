...
default[:aem][:dispatcher][:enabled] = true # ~FC001
default[:aem][:dispatcher][:rewrites] = [] # ~FC001
default[:aem][:dispatcher][:listen_port] = "80" # ~FC001
default[:aem][:dispatcher][:ssl_enabled] = false # ~FC001
default[:aem][:dispatcher][:ssl_cert_file] = "/etc/httpd/ssl/server.crt" # ~FC001
default[:aem][:dispatcher][:ssl_key_file] = "/etc/httpd/ssl/server.key" # ~FC001
default[:aem][:dispatcher][:expire_dirs] = [] # ~FC001
default[:aem][:dispatcher][:enable_etag] = false # ~FC001
default[:aem][:dispatcher][:enable_ie_header] = true # ~FC001
default[:aem][:dispatcher][:session_mgmt] = {  # ~FC001
    "directory" => "#{node[:apache][:dir]}/dispatcher/sessions", # ~FC001
    "header" => "Cookie:login-token" # ~FC001
  } # ~FC001
